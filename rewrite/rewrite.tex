...
\section*{Notation}
\addtocontents{toc}{\protect\setcounter{tocdepth}{2}} % end hack
	Let $\mathcal O_K$ be the ring of integers of $K$. We fix a pseudo-uniformiser $\pi\in \mathcal O_K$ such that $p\in\pi\mathcal O_K$. Let moreover $K^+$ be any open bounded integrally closed subring of $K$, then $K^+\subseteq \mathcal O_K$.
...
\end{remark}
	...
	\end{proof}
	\begin{corollary}
		Let $K^+\subseteq K$ be any open, bounded and integrally closed subring and let $A$ be the analytification over $(K,K^+)$ of an abelian variety over $K$. Then there is a perfectoid group $A_\infty$ over $(K,K^+)$ that is a tilde-limit $A_\infty\sim \varprojlim_{[p]} A$.
	\end{corollary}
	\begin{proof}
		This follows from Lemma~\ref{l:perf-tilde-lim-over-K+} and Theorem~\ref{tilde-limit of tilde-limits of partial towers is tilde-limit of whole tower}.1.
	\end{proof}
...
\begin{thebibliography}{99}
	...
	\bibitem{Hubers-book}
	Roland Huber, \textit{\'Etale cohomology of rigid analytic varieties and adic spaces}, Aspects of Mathematics, E30,
