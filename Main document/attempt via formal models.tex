...
%%%%%%%%%%%%	
	...
	\begin{notation} 
	Throughout we use the following shorthand notation: For any $a\in K$ we write
...
%%%%%%%%%%%%
	...
	\section{$p$-$F$-formal tower for Raynaud extensions}\label{Raynaud extensions as principal bundles of formal and rigid spaces}
