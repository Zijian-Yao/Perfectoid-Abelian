...
\begin{document}
	...
	\end{corollary}
	\begin{proof}
	We just need to check that $A$ satisfies the conditions of Proposition~\ref{limit exists and is perfectoid: commutative formal group case}. But $A$ is flat because it's smooth, and $[p]:A\rightarrow A$ is finite and thus affine.
	\end{proof}
	...
	By  Corollary~\ref{torus has formal models}, the multiplication map $[\mathfrak p]:\mathfrak T_{q^{1/p}} \rightarrow \mathfrak T_{q}$ reduces to relative Frobenius over $p$. In particular, we have 
